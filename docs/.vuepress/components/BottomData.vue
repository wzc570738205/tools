...
<template>
  <div class="templates-wrapper" style="background:#eff5fe">
    <div id="Banner5_0" class="home-page-wrapper banner5">
      <div class="home-page banner5-page">
        <div class="banner5-title-wrapper" data-edit="childWrapper">
          <h1
            name="title"
            class="banner5-title"
          ...
          <div
            name="content"
            class="banner5-content"
            style="opacity: 1; transform: translate(0px, 0px);"
          >
            <span>理想的光芒很难照进现实</span>
          </div>
          <div
            name="button"
            class="banner5-button-wrapper"
            style="opacity: 1; transform: translate(0px, 0px);"
          >
            <a
              href="#"
              data-edit="link,text"
              class="ant-btn banner5-button ant-btn-primary"
              @click="go()"
            >
              <span>
                开始吧
        ...
        <div class="banner5-image" style="transform: translate(0px, 0px); opacity: 1;">
          <img src="https://picsum.photos/860/880" width="100%" alt="img" />
        </div>
      </div>
    </div>
  </div>
...
.ant-modal.zoom-enter,.ant-modal.zoom-appear,.ant-image-preview.zoom-enter,.ant-image-preview.zoom-appear {
...
.ant-modal-mask-hidden,.ant-image-preview-mask-hidden {
    display: none
}
...
html {
    --antd-wave-shadow-color: #2F54EB;--scroll-bar: 0}
...
.ant-menu-horizontal .ant-menu-item,.ant-menu-horizontal .ant-menu-submenu-title {
    -webkit-transition: color .3s cubic-bezier(.645,.045,.355,1),border-color .3s cubic-bezier(.645,.045,.355,1),background .3s cubic-bezier(.645,.045,.355,1);
...
.ant-menu-submenu-vertical>.ant-menu-submenu-title .ant-menu-submenu-arrow::before,.ant-menu-submenu-vertical-left>.ant-menu-submenu-title .ant-menu-submenu-arrow::before,.ant-menu-submenu-vertical-right>.ant-menu-submenu-title .ant-menu-submenu-arrow::before,.ant-menu-submenu-inline>.ant-menu-submenu-title .ant-menu-submenu-arrow::before,.ant-menu-submenu-vertical>.ant-menu-submenu-title .ant-menu-submenu-arrow::after,.ant-menu-submenu-vertical-left>.ant-menu-submenu-title .ant-menu-submenu-arrow::after,.ant-menu-submenu-vertical-right>.ant-menu-submenu-title .ant-menu-submenu-arrow::after,.ant-menu-submenu-inline>.ant-menu-submenu-title .ant-menu-submenu-arrow::after {
    ...
    width: 6px;
    height: 1.5px;
    background-image: -webkit-gradient(linear,left top,right top,from(#314659),to(#314659));
    background-image: linear-gradient(to right,#314659,#314659);
    border-radius: 2px;
...
.ant-menu-submenu-vertical>.ant-menu-submenu-title:hover .ant-menu-submenu-arrow::after,.ant-menu-submenu-vertical-left>.ant-menu-submenu-title:hover .ant-menu-submenu-arrow::after,.ant-menu-submenu-vertical-right>.ant-menu-submenu-title:hover .ant-menu-submenu-arrow::after,.ant-menu-submenu-inline>.ant-menu-submenu-title:hover .ant-menu-submenu-arrow::after,.ant-menu-submenu-vertical>.ant-menu-submenu-title:hover .ant-menu-submenu-arrow::before,.ant-menu-submenu-vertical-left>.ant-menu-submenu-title:hover .ant-menu-submenu-arrow::before,.ant-menu-submenu-vertical-right>.ant-menu-submenu-title:hover .ant-menu-submenu-arrow::before,.ant-menu-submenu-inline>.ant-menu-submenu-title:hover .ant-menu-submenu-arrow::before {
    background: -webkit-gradient(linear,left top,right top,from(#2F54EB),to(#2F54EB));
    background: linear-gradient(to right,#2F54EB,#2F54EB)
}

.ant-menu-submenu-vertical>.ant-menu-submenu-title .ant-menu-submenu-arrow::before,.ant-menu-submenu-vertical-left>.ant-menu-submenu-title .ant-menu-submenu-arrow::before,.ant-menu-submenu-vertical-right>.ant-menu-submenu-title .ant-menu-submenu-arrow::before {
    -webkit-transform: rotate(45deg) translateY(-2px);
    transform: rotate(45deg) translateY(-2px)
}

.ant-menu-submenu-vertical>.ant-menu-submenu-title .ant-menu-submenu-arrow::after,.ant-menu-submenu-vertical-left>.ant-menu-submenu-title .ant-menu-submenu-arrow::after,.ant-menu-submenu-vertical-right>.ant-menu-submenu-title .ant-menu-submenu-arrow::after {
    -webkit-transform: rotate(-45deg) translateY(2px);
    transform: rotate(-45deg) translateY(2px)
}
...
.ant-menu-rtl.ant-menu-vertical.ant-menu-sub,.ant-menu-rtl.ant-menu-vertical-left.ant-menu-sub,.ant-menu-rtl.ant-menu-vertical-right.ant-menu-sub {
...
.header0-item .ant-menu-sub .ant-menu-item,.header0-item-child .ant-menu-sub .ant-menu-item,.header0-menu .ant-menu-sub .ant-menu-item,.header0-item .ant-menu-inline .ant-menu-item,.header0-item-child .ant-menu-inline .ant-menu-item,.header0-menu .ant-menu-inline .ant-menu-item {
    height: auto;
    line-height: 1.5
}
...
.header1-menu>.ant-menu a {
    color: inherit
}

.header1-menu>.ant-menu a:hover {
    color: #2f54eb
}

.header1-menu .help {
    border-left: 1px solid rgba(233,233,233,.05)!important
}

.header1-menu .help .anticon {
    font-size: 16px;
    vertical-align: middle
}

.header1-menu .help span {
    display: inline-block;
    font-size: 12px
}
...
.header1-menu .user .img img {
    vertical-align: middle
}

.header1-menu .user span {
    margin-left: 10px
}

.header1 .ant-menu-item-selected a {
    color: #2f54eb
}
...
@media screen and (max-width: 767px) {
    ...
    .header1.home-page-wrapper .home-page {
        padding: 0 24px
    }

    .header1 .header1-menu {
        height: auto;
        float: inherit;
        position: relative;
        left: -24px;
    ...
    .header1-mobile-menu :first-child {
        margin-top: 0
    }
    ...
    .header1 .ant-menu .ant-menu-item-selected {
        border: none
    }
    ...
    .header1 .ant-menu a:hover {
        color: #fff
    }

    .header1 .ant-menu .ant-menu-item-selected a {
        color: #fff
    }
    ...
    .header1 .open .header1-mobile-menu em:nth-child(1) {
        transform: translateY(6px) rotate(45deg)
    }

    .header1 .open .header1-mobile-menu em:nth-child(2) {
        opacity: 0
    }

    .header1 .open .header1-mobile-menu em:nth-child(3) {
        transform: translateY(-6px) rotate(-45deg)
    }

    .header1 .open>.header1-menu {
        opacity: 1;
        pointer-events: auto
    }
}
...
.header2-menu>.menu-item.active,.header2-menu>.menu-item:hover {
    color: #2f54eb;
    border-bottom: 2px solid #2f54eb
}
...
.header3-item .ant-menu-sub .ant-menu-item,.header3-item-child .ant-menu-sub .ant-menu-item,.header3-menu .ant-menu-sub .ant-menu-item,.header3-item .ant-menu-inline .ant-menu-item,.header3-item-child .ant-menu-inline .ant-menu-item,.header3-menu .ant-menu-inline .ant-menu-item {
    height: auto;
    line-height: 1.5
}

.header3-item .item-sub-item,.header3-item-child .item-sub-item,.header3-menu .item-sub-item {
    display: block;
    padding: 8px 24px
}

.header3-item .item-image,.header3-item-child .item-image,.header3-menu .item-image {
    float: left;
    margin-right: 16px;
    margin-top: 4px;
    position: relative;
...
.header3-item .item-title,.header3-item-child .item-title,.header3-menu .item-title {
    font-size: 14px;
    color: #314659;
    margin-left: 46px
}

.header3-item .item-content,.header3-item-child .item-content,.header3-menu .item-content {
    font-size: 12px;
...
.banner4-image,.banner4-image-mobile {
    width: 80%;
    max-height: 60%;
    overflow: hidden;
    margin: auto;
...
.banner5-button-wrapper .banner5-button {
    ...
    box-shadow: 0 8px 24px rgba(95,155,241,.35);
    border-radius: 20px;
    border: none;
    padding: 0 42px;
    line-height: 40px;
...
.banner5-button-wrapper .banner5-button:hover {
    ...
    box-shadow: 0 13px 24px rgba(95,155,241,.45);
    background-image: linear-gradient(to right bottom,#82b5ff 0%,#3c89f6 0%)
}
...
.content6-wrapper .content6-text ul li .content6-title,.content6-wrapper .content6-text ul li .content6-content {
    margin-left: 45px
}
...
.ant-tabs-rtl.ant-tabs-card.ant-tabs-top>.ant-tabs-nav .ant-tabs-tab:not(:last-of-type),.ant-tabs-rtl.ant-tabs-card.ant-tabs-bottom>.ant-tabs-nav .ant-tabs-tab:not(:last-of-type),.ant-tabs-rtl.ant-tabs-card.ant-tabs-top>div>.ant-tabs-nav .ant-tabs-tab:not(:last-of-type),.ant-tabs-rtl.ant-tabs-card.ant-tabs-bottom>div>.ant-tabs-nav .ant-tabs-tab:not(:last-of-type) {
    margin-right: 0;
    margin-left: 2px
}
...
.ant-tabs-left>.ant-tabs-nav .ant-tabs-tab:last-of-type,.ant-tabs-right>.ant-tabs-nav .ant-tabs-tab:last-of-type,.ant-tabs-left>div>.ant-tabs-nav .ant-tabs-tab:last-of-type,.ant-tabs-right>div>.ant-tabs-nav .ant-tabs-tab:last-of-type {
    margin-bottom: 0
}
...
.ant-tabs-card.ant-tabs-left>.ant-tabs-nav .ant-tabs-tab:not(:last-of-type),.ant-tabs-card.ant-tabs-right>.ant-tabs-nav .ant-tabs-tab:not(:last-of-type),.ant-tabs-card.ant-tabs-left>div>.ant-tabs-nav .ant-tabs-tab:not(:last-of-type),.ant-tabs-card.ant-tabs-right>div>.ant-tabs-nav .ant-tabs-tab:not(:last-of-type) {
    margin-bottom: 2px
}
...
@media screen and (max-width: 767px) {
    ...
    .content7-wrapper .content7-text,.content7-wrapper .content7-img {
        text-align: left;
        padding: 0
    }
...
.pricing1-wrapper .pricing1-block-box.active .pricing1-name,.pricing1-wrapper .pricing1-block-box.active .pricing1-money,.pricing1-wrapper .pricing1-block-box.active .pricing1-button {
    color: #fff
}
...
.ant-table.ant-table-bordered>.ant-table-container>.ant-table-content>table>thead>tr:not(:last-child)>th,.ant-table.ant-table-bordered>.ant-table-container>.ant-table-header>table>thead>tr:not(:last-child)>th,.ant-table.ant-table-bordered>.ant-table-container>.ant-table-body>table>thead>tr:not(:last-child)>th {
    border-bottom: 1px solid #f0f0f0
}
...
.ant-table.ant-table-bordered>.ant-table-container>.ant-table-content>table>tbody>tr>td>.ant-table-expanded-row-fixed,.ant-table.ant-table-bordered>.ant-table-container>.ant-table-header>table>tbody>tr>td>.ant-table-expanded-row-fixed,.ant-table.ant-table-bordered>.ant-table-container>.ant-table-body>table>tbody>tr>td>.ant-table-expanded-row-fixed {
    margin: -16px -17px
}

.ant-table.ant-table-bordered>.ant-table-container>.ant-table-content>table>tbody>tr>td>.ant-table-expanded-row-fixed::after,.ant-table.ant-table-bordered>.ant-table-container>.ant-table-header>table>tbody>tr>td>.ant-table-expanded-row-fixed::after,.ant-table.ant-table-bordered>.ant-table-container>.ant-table-body>table>tbody>tr>td>.ant-table-expanded-row-fixed::after {
    position: absolute;
    top: 0;
    right: 1px;
    bottom: 0;
...
.ant-radio-input:focus+.ant-radio-inner {
    -webkit-box-shadow: 0 0 0 3px rgba(47,84,235,.08);
...
.ant-pagination-options-quick-jumper input:focus,.ant-pagination-options-quick-jumper input-focused {
    ...
    border-right-width: 1px!important;
    outline: 0;
    -webkit-box-shadow: 0 0 0 2px rgba(47,84,235,.2);
...
.ant-pagination-rtl .ant-pagination-prev,.ant-pagination-rtl .ant-pagination-jump-prev,.ant-pagination-rtl .ant-pagination-jump-next {
    margin-right: 0;
    margin-left: 8px
}
